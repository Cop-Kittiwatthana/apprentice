            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center">
                        <h4 class="text-dark"><i class="fas fa-plus"></i> แก้ไขข้อมูลสถานประกอบการ</h4>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="c_user" id="c_user" value="<?= $c_user ?>" class="form-control" placeholder="-กรุณาใส่ชื่อผู้ใช้-" onkeypress="isInputPassword(event)" required type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
