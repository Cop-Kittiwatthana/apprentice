            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center">
                        <h4 class="text-dark"><i class="fas fa-plus"></i> เพิ่มข้อมูลผลงานนักศึกษา</h4>
                    </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="pf_na" id="pf_na" class="form-control" placeholder="-กรุณาใส่ชื่อผลงาน-" onkeypress="isInputChar(event)" required type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
