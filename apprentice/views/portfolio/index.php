            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <!-- <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">ข้อมูลผลงานนักศึกษา</li>
                        </ol> -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <font size="6" face="TH SarabunPSK"> รายงานข้อมูลผลงานนักศึกษา </font><a href="add.php"><span class="btn btn-primary fa fas-plus float-right "><i class="fas fa-plus-circle"> เพิ่มข้อมูลผลงานนักศึกษา</i></a>
                                </h6>
                            </div>
                            <div class="card-body">
