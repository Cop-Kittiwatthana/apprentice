            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <!-- <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">ข้อมูลความต้องการ</li>
                        </ol> -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <font size="6" face="TH SarabunPSK"> รายงานข้อมูลความต้องการ </font><a href="add.php"><span class="btn btn-primary fa fas-plus float-right "><i class="fas fa-plus-circle"> เพิ่มข้อมูลความต้องการ</i></a>
                                </h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered " id="data" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #f8f9fc;">จำนวน</th>
