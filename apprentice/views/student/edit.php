            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center">
                        <h4 class="text-dark"><i class="fas fa-plus"></i> แก้ไขข้อมูลนักศึกษา</h4>
                    </div>
                            ...
                            <tr>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="s_fna" id="s_fna" maxlength="25" value="<?= $s_fna ?>" class="form-control" placeholder="-กรุณาใส่ชื่อ-" onkeypress="isInputCharth(event)" required type="text">
                                            </div>
                                        </td>
                                    </div>
                                    <div class="col-md-5">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="s_lna" id="s_lna" maxlength="25" value="<?= $s_lna ?>" class="form-control" placeholder="-กรุณาใส่นามสกุล-" onkeypress="isInputCharth(event)" required type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="s_group" id="s_group" value="<?= $s_group ?>" maxlength="2" class="form-control" placeholder="-กรุณาใส่กลุ่ม-" onkeypress="isInputNumber(event)" required type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
