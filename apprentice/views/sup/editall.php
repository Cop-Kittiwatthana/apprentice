                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <li class="breadcrumb-item"><a href="indexsup.php?year=<?= $pe_semester ?>">หน้าหลัก</a></li>
                            ...
                            <li class="breadcrumb-item active">แก้ไขข้อมูลอาจารย์นิเทศทังหมด</li>
                        </ol>
                    </div>
                    <br>
                    <div class="text-center">
                        <h4 class="text-dark"><i class="fas fa-plus"></i> แก้ไขข้อมูลอาจารย์นิเทศทังหมด</h4>
                    </div>
                    <form action="sql.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <select name="company" id="company" class="form-control action">
                                                    ...
                                                    <?php $query = "SELECT company.* FROM company
                                                    LEFT JOIN demand ON company.c_id  = demand.c_id 
                                                    LEFT JOIN petition ON demand.de_id  = petition.de_id
                                                    WHERE  demand.br_id = '$br_id' and (  petition.pe_status = 5 or petition.pe_status = 6 ) 
                                                    and petition.pe_semester = '$pe_semester'
                                                    GROUP BY demand.c_id";
                        ...
                        <div class="container text-dark " style="width: 80%; height: auto;">
                            ...
                            <div class="footer d-flex justify-content-center">
                                ...
                                <button class="btn btn-success btn-lg" type="submit" name="btneditall" id="btneditall" value="บันทึก">บันทึก</button>&nbsp;
