...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	$nestedData[] = $row['detail'] = '<div align="center">' . "<a href=\"indexstd.php?c_id=$row[c_id]&pe_semester=$row[pe_semester]\">" . '<button type="button" class="btn btn-info"><i class="fas fa-info-circle"> เอกสารการฝึกงาน </i></button>';
	$data[] = $nestedData;
}
