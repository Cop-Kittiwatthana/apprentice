                ...
                <div id="content">
                    ...
                    <div class="container text-dark " style="width: 80%; height: auto;">
                                         ...
                                         group by student.s_id";
                                            ...
                                            while ($row = mysqli_fetch_array($result)) { ?>
                                                <tr class="text-dark" style="text-align: center;">
                                                    ...
                                                    <td><?php echo "<a href=\"indexstddoc.php?pe_id=$row[pe_id]&s_id=$row[s_id]&c_id=$c_id&pe_semester=$pe_semester\">" ?><button type="button" class="btn btn-warning btn fa fa-edit text-dark"><span style="color:black;">จัดการเอกสาร</span></button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                        ...
                        <!-- <div class="footer d-flex justify-content-center">
                            <a href="index.php"><button class="btn btn-primary btn-lg">กลับ</button></a>
                        </div> -->
                    </div>
                </div>
