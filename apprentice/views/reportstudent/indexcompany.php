        ...
        <script type="text/javascript" language="javascript">
            $(document).ready(function() {
                var dataTable = $('#data').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: "datacompany.php", // json datasource
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <font size="6" face="TH SarabunPSK"> รายงานข้อมูลสถานประกอบการ </font>
                                    <a href="pdfcompany.php" target='blank'><span class="btn btn-primary fa fas-plus float-left "><i class="fa fa-print" aria-hidden="true"></i></a>
                                </h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered " id="data" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #f8f9fc;">ที่อยู่</th>
