...
if (mysqli_num_rows($result1) > 0) {
    if (mysqli_num_rows($result1) > 0) {
        ...
        while ($row1 = mysqli_fetch_assoc($result1)) {
            ...
            $tablebody .= '<tr style="border:1px solid #000;">
                <td style="border-right:1px solid #000;padding:3px;text-align:center;">' . $row1['c_na'] . '</td>
                <td style="border-right:1px solid #000;padding:3px;text-align:center;">' . $address . '</td>
                <td style="border-right:1px solid #000;padding:3px;text-align:center;">' . $cs_tel . '</td>
                </tr>';
            $i++;
        }
    }
    ...
    <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:14pt;margin-top:4px;">
        <tr style="border:1px solid #000;padding:4px;">
            <td  style="border-right:1px solid #000;padding:4px;text-align:center;"width="40%">&nbsp; <b> ชื่อสกุล  </b></td>
            <td  style="border-right:1px solid #000;padding:4px;text-align:center;" width="40%"> <b>ที่อยู่ </b></td>
            <td  style="border-right:1px solid #000;padding:4px;text-align:center;" width="20%"> <b>เบอร์โทร </b></td>
        </tr>
