            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <li class="breadcrumb-item"><a href="indexme.php?t_id=<?= $t_id ?>">ข้อมูลส่วนตัวอาจารย์</a></li>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="t_user" id="t_user" value="<?= $t_user ?>" class="form-control" placeholder="-กรุณาใส่ชื่อผู้ใช้-" onkeypress="isInputPassword(event)" readonly type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <textarea name="t_add" id="t_add" class="form-control" placeholder="-กรุณาใส่ที่อยู่-"  type="text"><?= $t_add ?></textarea>
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <th>รูป :</th>
                                        <?php if ($photo != "") { ?>
                                            <img echo src="../../picture/<?= $photo ?>" style="display:block;" width="120px" height="auto" id="preview" class="img-thumbnail">
                                        <?php } else { ?>
                                            <img src="../../picture/<?= $photo ?>" style="display:none;" width="120px" height="auto" id="preview" class="img-thumbnail">
                                        <?php  } ?>
                                        <td>
