                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="m-0 font-weight-bold text-dark" style="text-align: center;">
                                    <font size="6" face="TH SarabunPSK"> <?= $s_tna . '&nbsp;' . $s_fna . '&nbsp;' . $s_lna ?><br> สถานประกอบการ<?= $c_na ?></font>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered " id="data" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $query1 = "SELECT * FROM supervision 
                                    ...
                                    <a href="pdf.php?pe_id=<?= $pe_id ?>&su_term=1" target='blank'><button class="btn btn-primary fa fas-plus float-left "><i class="fa fa-print" aria-hidden="true"></i>เทอม 1</button></a>
                                    <a href="pdf.php?pe_id=<?= $pe_id ?>&su_term=2" target='blank'><button class="btn btn-primary fa fas-plus float-left "><i class="fa fa-print" aria-hidden="true"></i>เทอม 2</button></a>
                                </div>
                            </div>
