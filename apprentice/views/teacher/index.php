                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <font size="6" face="TH SarabunPSK"> รายงานข้อมูลอาจารย์ </font>
                                    <a href="add.php"><span class="btn btn-primary fa fas-plus float-right "><i class="fas fa-plus-circle"> เพิ่มข้อมูลอาจารย์</i></a>
                                </h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered " id="data" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background-color: #f8f9fc;" width="100">คำนำหน้า</th>
                                                <th style="background-color: #f8f9fc;">ชื่อสกุล</th>
                                                <th style="background-color: #f8f9fc;">ตำแหน่ง</th>
                                                <th style="background-color: #f8f9fc;">ประเภทผู้ใช้</th>
