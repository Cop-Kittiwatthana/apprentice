            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center">
                        <h4 class="text-dark"><i class="fas fa-plus"></i> เเก้ไขข้อมูลข่าวสาร</h4>
                    </div>
                    <form action="sql.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <input name="n_pic" type="hidden" id="n_pic" value="<?= "$n_pic"; ?>" />
                        <input name="n_file" type="hidden" id="n_file" value="<?= "$n_file"; ?>" />
                            <br>
                            <tr>
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input class="form-control" readonly type="text" size="10" id="n_date" name="n_date" value="<?= $n_date ?>" require />
                                            </div>
                                        </td>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <td>
                                            <div class="input-group mb-3" >
                                                ...
                                                <input class="form-control" required  placeholder="กรุณาเลือก ว/ด/ป " autocomplete="off" type="text" value="<?= $n_enddate ?>" name="n_enddate" id="n_enddate" />
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input name="n_na" id="n_na" value="<?= $n_na ?>" class="form-control" placeholder="-กรุณาใส่หัวข้อข่าว-"  required type="text">
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <textarea name="n_detail" id="n_detail"  class="form-control" placeholder="-กรุณาใส่รายละเอียดข่าว-" onkeypress="isInputChar2(event)" type="text"><?= $n_detail ?></textarea>
                                            </div>
                                        </td>
                                    </div>
                                </div>
                            ...
                            <tr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <th>รูป :</th>
                                        <?php if ($n_pic != "") { ?>
                                            <img src="../../picture/<?= $n_pic ?>" style="display:block;" width="400" height="auto" id="preview" class="img-thumbnail">
                                        <?php } else { ?>
                                            <img src="../../picture/<?= $n_pic ?>" style="display:none;" width="400" height="auto" id="preview" class="img-thumbnail">
                                        <?php  } ?>
                                        <td>
                                            <div class="form-group mb-3">
                                                <input type="file" name="img" class="file-field" accept="image/*">
                                                <div class="input-group">
                                                    <input type="text"  class="form-control" disabled placeholder="Upload File" id="photo" value="<?= $n_pic ?>">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <td>
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" disabled placeholder="Upload File" id="file" value="<?= $n_file ?>">
                                                    <div class="input-group-append">
