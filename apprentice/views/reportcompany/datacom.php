...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	// }
	$nestedData[] = $row['detail'] = '<div align="center">' . "<a href=\"indexstdsum.php?c_id=$row[c_id]\">" . '<button type="button" class="btn btn-info"><i class="fas fa-info-circle"> รายชื่อนักศึกษา </i></button>';
