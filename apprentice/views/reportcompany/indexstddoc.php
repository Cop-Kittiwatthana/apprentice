                                         ...
                                         OR petition.pe_status = 6 OR petition.pe_status = 7 OR petition.pe_status = 8) ORDER BY student.s_id ASC";
                                            ...
                                            while ($row = mysqli_fetch_array($result)) { ?>
                                                <tr class="text-dark" style="text-align: center;">
                                                    ...
                                                    <td><?php echo "<a href=\"documents.php?pe_id=$row[pe_id]&s_id=$row[s_id]&c_id=$c_id&pe_semester=$pe_semester\">" ?><button type="button" class="btn btn-warning btn fa fa-edit text-dark"><span style="color:black;">เอกสาร</span></button></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
