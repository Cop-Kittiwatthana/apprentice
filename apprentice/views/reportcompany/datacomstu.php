...
while ($row = mysqli_fetch_array($result)) {
	...
	$nestedData[] = $row['detail'] = '<div align="center">' . "<a href=\"indexstudentpdf.php?c_id=$row[c_id]&pe_semester=$date&su_term=1\">" . '<button type="button" class="btn btn-info">&nbsp;&nbsp;&nbsp;<i class="fas fa-info-circle"> เทอม1&nbsp;&nbsp;&nbsp;</i></button></a>
	' . "<a  href=\"indexstudentpdf.php?c_id=$row[c_id]&pe_semester=$date&su_term=2\">" . '<button type="button" class="btn btn-info">&nbsp;&nbsp;&nbsp;<i class="fas fa-info-circle"> เทอม2&nbsp;&nbsp;&nbsp;</i></button>';
	$data[] = $nestedData;
}
