        ...
        <script type="text/javascript" language="javascript">
            $(document).ready(function() {
                var dataTable = $('#data').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        url: "datacom.php", // json datasource
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">รายชื่อข้อมูลสถานประกอบการ</li>
                        </ol>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <font size="6" face="TH SarabunPSK"> รายชื่อข้อมูลสถานประกอบการ </font>
                                    <a href="pdf.php" target='blank'><span class="btn btn-primary fa fas-plus float-left "><i class="fa fa-print" aria-hidden="true"></i></a>
                                </h6>
                            </div>
                            <div class="card-body">
