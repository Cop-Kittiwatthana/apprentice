        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <ol class="breadcrumb mb-4">
              ...
              <li class="breadcrumb-item active">แก้ไขข้อมูลแผนก</li>
            </ol>
          </div>
          <br>
          <center>
            <h4 class="text-dark"><i class="fas fa-plus"></i> แก้ไขข้อมูลแผนก</h4>
          </center>
          <form action="sql.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <div class="container text-dark " style="width: 60%; height: auto;">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="-กรอกชื่อแผนก-" onkeypress="isInputChar(event)" required type="text" name="dp_na" id="dp_na" value="<?= $dp_na ?>" />
              </div>
