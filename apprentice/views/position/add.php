...
if (isset($_SESSION["username"]) && isset($_SESSION["password"]) &&  $_SESSION["status"] == '0') {
  ...
  $query_geographies = "SELECT * FROM geographies";
  $result_geographies = mysqli_query($conn, $query_geographies);
?>
  <!DOCTYPE html>
  <html lang="en">
          ...
          <form action="sql.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <div class="container text-dark " style="width: 60%; height: auto;">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="-กรอกชื่อตำแหน่ง-" onkeypress="isInputChar(event)" required type="text" name="p_na" id="p_na">
              </div>
