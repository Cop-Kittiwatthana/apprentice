                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">รายงานข้อมูลอาจารย์ทีปรึกษา</li>
                        </ol>
                        <div class="card shadow mb-4">
                            <object data="pdf.php?id=<?= $id ?>&br_id=<?= $br_id ?>&s_group=<?= $s_group ?>" type="application/pdf" width="100%" height="580px">
