                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <font size="6" face="TH SarabunPSK"> รายงานข้อมูลความต้องการ[<?= $c_na ?>] </font><a href="add.php?c_id=<?= $c_id; ?>">
                                    <span class="btn btn-primary fa fas-plus float-right "><i class="fas fa-plus-circle"> เพิ่มข้อมูลความต้องการ</i></a>
                            </h6>
                            </div>
                            <div class="card-body">
