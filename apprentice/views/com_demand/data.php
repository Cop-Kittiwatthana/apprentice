...
$sql .= " where 1=1 and demand.c_id = $c_id";
...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	$nestedData[] = $row['detail']= '<div align="center">' . "<a href=\"detail.php?c_id=$c_id&de_id=$row[de_id]\">" . '<button type="button" class="btn btn-info"><i class="fas fa-info-circle"> รายละเอียด </i></button>';
	$nestedData[] = $row['edit/delect'] = 
		'<div align="center">' . "<a href=\"edit.php?c_id=$c_id&de_id=$row[de_id]\">" . '<button type="button" class="btn btn-success"><i class="fas fa-edit"> แก้ไข </i></button>&nbsp;' .
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<font class="d-flex justify-content-center " size="6" face="TH SarabunPSK"><p style="color:red">ต้องการลบใช่หรือไม่</p></font>
						</div>
