...
if($su_term == 1){
    $su_term = 'supervision.su_no BETWEEN 1 AND 3';
}else{
    $su_term = 'supervision.su_no BETWEEN 4 AND 6';
}
...
WHERE  student.s_group = '$s_group'  and student.br_id= '$br_id' and student.s_id LIKE '$id%' and $su_term
or student.s_group = '$s_group'  and student.br_id= '$br_id' and student.s_id LIKE '$id%'
