            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="indexdiseaser.php?t_id=<?= $t_id ?>">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">รายงานข้อมูลโรคประจำตัวนักศึกษาฝึกงาน</li>
                        </ol>
                        <div class="card shadow mb-4">
                            <object data="pdfdiseaser.php?id=<?= $id ?>&br_id=<?= $br_id ?>&s_group=<?= $s_group ?>" type="application/pdf" width="100%" height="580px">
