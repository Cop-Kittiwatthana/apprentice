...
while ($row = mysqli_fetch_array($result)) {
	...
	$nestedData[] = $row['detail'] = '<div align="center">' . "<a href=\"indexpdfdiseaser.php?id=$row[id]&br_id=$row[br_id]&s_group=$row[s_group]\">" . '<button type="button" class="btn btn-info"><i class="fas fa-info-circle"> รายชื่อนักศึกษา </i></button>';
	$data[] = $nestedData;
}
