                            ...
                            <div class="card card shadow mb-4">
                                <!-- <div class="col-6 col-sm-4 col-md-4" style="margin-bottom: 20px;"> -->
                                    ...
                                    <?php if ($n_pic != "") { ?>
                                        ...
                                        <?php  } ?>
                                        <div class="card-body">
                                            <h5 class="card-title" id="card_topic"><font size="5" face="TH SarabunPSK"><b><?= $row['n_na'] ?></b></font></h5>
                                            <a href="indexviewdetailnew.php?id=<?= $row['n_id'] ?>" class="btn btn-primary btn-sm"><font size="4" face="TH SarabunPSK"><b style="color: white;">Read More..</b></font></a>
                                        </div>
                                    </div>
                                </div>
                        </div>
